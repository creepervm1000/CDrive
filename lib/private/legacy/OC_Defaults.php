 ...
 *
 * CDrive fork modifications: renamed defaults to CDrive, AMOLED black
 * defaults. Original notices preserved per AGPLv3 sec. 4-5.
...
class OC_Defaults {
	...
	public function __construct() {
		...
		$this->defaultEntity = 'CDrive'; /* e.g. company name, used for footers and copyright notices - CDrive fork of Nextcloud */
		$this->defaultName = 'CDrive'; /* short name, used when referring to the software - CDrive fork */
		$this->defaultTitle = 'CDrive'; /* can be a longer name, for titles - CDrive fork */
		$this->defaultBaseUrl = 'https://cdrive.example';
		$this->defaultSyncClientUrl = $config->getSystemValue('customclient_desktop', 'https://cdrive.example/install/#install-clients');
		$this->defaultiOSClientUrl = $config->getSystemValue('customclient_ios', 'https://cdrive.example/ios');
		$this->defaultiTunesAppId = $config->getSystemValue('customclient_ios_appid', '');
		$this->defaultAndroidClientUrl = $config->getSystemValue('customclient_android', 'https://cdrive.example/android');
		$this->defaultFDroidClientUrl = $config->getSystemValue('customclient_fdroid', 'https://cdrive.example/fdroid');
		$this->defaultDocBaseUrl = 'https://cdrive.example/docs';
		$this->defaultDocVersion = $serverVersion->getMajorVersion(); // used to generate doc links
		$this->defaultColorBackground = '#000000';
		$this->defaultColorPrimary = '#00C853';
		$this->defaultTextColorPrimary = '#000000';
		$this->defaultProductName = 'CDrive';
