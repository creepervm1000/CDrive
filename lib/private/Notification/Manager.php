 ...
 *
 * CDrive fork modifications: push fair-use paywall removed.
 */
...
class Manager implements IManager {
	...
	public function isFairUseOfFreePushService(): bool {
		// CDrive: push paywall removed. Push is free for any number of users;
		// no subscription check, no user counting, no rate-limit flag.
		return true;
	}
