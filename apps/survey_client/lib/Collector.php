 ...
 *
 * CDrive fork: sendReport() never transmits. Reports stay local only.
 */
...
class Collector {
	...
	public function sendReport(): DataResponse {
		// CDrive: telemetry disabled. The report is built for local
		// inspection only and is never transmitted anywhere.
		$report = $this->getReport();
		$this->logger->info('CDrive: usage survey report built locally, not sent.');
