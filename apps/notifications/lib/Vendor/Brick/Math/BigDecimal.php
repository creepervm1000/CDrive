...
use OCA\Notifications\Vendor\Brick\Math\Exception\InvalidArgumentException;
...
use OCA\Notifications\Vendor\Brick\Math\Exception\UnsupportedPlatformException;
use OCA\Notifications\Vendor\Brick\Math\Internal\CalculatorRegistry;
use OCA\Notifications\Vendor\Brick\Math\Internal\DecimalHelper;
use OCA\Notifications\Vendor\Brick\Math\Internal\Safe;
use LogicException;
use Override;
use function assert;
use function chr;
...
final readonly class BigDecimal extends BigNumber
{
    ...
    public function nthRoot(int $n, int $scale, RoundingMode $roundingMode = RoundingMode::Unnecessary): BigDecimal
    {
        ...
        if (!$isExact) {
            ...
            } elseif (in_array($roundingMode, [RoundingMode::HalfDown, RoundingMode::HalfEven, RoundingMode::HalfFloor, RoundingMode::HalfCeiling], true)) {
                $roundingMode = RoundingMode::HalfUp;
            }
        }
