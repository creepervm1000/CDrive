...
namespace OCA\Notifications\Vendor\Http\Discovery;

use OCA\Notifications\Vendor\Http\Discovery\Exception\ClassInstantiationFailedException;
use OCA\Notifications\Vendor\Http\Discovery\Exception\DiscoveryFailedException;
use OCA\Notifications\Vendor\Http\Discovery\Exception\NoCandidateFoundException;
use OCA\Notifications\Vendor\Http\Discovery\Exception\StrategyUnavailableException;
use OCA\Notifications\Vendor\Http\Discovery\Strategy\DiscoveryStrategy;
/**
...
abstract class ClassDiscovery
{
    ...
    private static $deprecatedStrategies = [Strategy\PuliBetaStrategy::class => true];
    /**
