 ...
 *
 * CDrive fork: lookup server opt-in (default empty, see below).
 */
...
class RetryJob extends Job {
	...
	public function __construct(
		...
		// CDrive: no default lookup server (opt-in). Empty means disabled.
		$this->lookupServer = $this->config->getSystemValue('lookup_server', '');
