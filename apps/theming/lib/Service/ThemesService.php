 ...
 * CDrive AMOLED themes registered below. Original notices preserved per AGPLv3.
 */
...
use OCA\Theming\Themes\CDriveAmoledBlackTheme;
use OCA\Theming\Themes\CDriveGreenAmoledTheme;
use OCA\Theming\Themes\CDriveMonoIconsTheme;
use OCA\Theming\Themes\CDriveOrangeAmoledTheme;
...
class ThemesService {
	...
	public function __construct(
		...
		CDriveAmoledBlackTheme $cdriveAmoledBlack,
		CDriveGreenAmoledTheme $cdriveGreenAmoled,
		CDriveOrangeAmoledTheme $cdriveOrangeAmoled,
		CDriveMonoIconsTheme $cdriveMonoIcons,
	) {
		...
		$this->themesProviders = [
			...
			$cdriveAmoledBlack->getId() => $cdriveAmoledBlack,
			$cdriveGreenAmoled->getId() => $cdriveGreenAmoled,
			$cdriveOrangeAmoled->getId() => $cdriveOrangeAmoled,
			$cdriveMonoIcons->getId() => $cdriveMonoIcons,
		];
	}
