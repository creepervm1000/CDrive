 ...
 *
 * CDrive fork: default background is original CDrive AMOLED artwork.
 */
...
class BackgroundService {
	...
	public const DEFAULT_BACKGROUND_IMAGE = 'cdrive-amoled-glow.webp';
	...
	public const SHIPPED_BACKGROUNDS = [
		'cdrive-amoled-glow.webp' => [
			'attribution' => 'AMOLED glow (CDrive contributors, AGPL-3.0-or-later)',
			'description' => 'Original abstract CDrive background: green aurora glow on pure black',
			'attribution_url' => '',
			'dark_variant' => 'cdrive-amoled-glow-dark.webp',
