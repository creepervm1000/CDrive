 ...
 *
 * CDrive Orange AMOLED theme. Pure #000000 backgrounds, NO WHITE surfaces.
...
class CDriveOrangeAmoledTheme extends DarkTheme implements ITheme {

	#[\Override]
	public function getId(): string {
		return 'cdrive-orange-amoled';
	}

	#[\Override]
	public function getTitle(): string {
		return $this->l->t('CDrive Orange AMOLED');
	}

	#[\Override]
	public function getEnableLabel(): string {
		return $this->l->t('Enable CDrive Orange AMOLED');
	}

	#[\Override]
	public function getDescription(): string {
		return $this->l->t('Pure AMOLED black (#000000) with vivid orange accent. No white surfaces.');
	}
	...
	public function getCSSVariables(): array {
		// Vivid orange, high contrast on pure black
		$this->primaryColor = '#FF6D00';
