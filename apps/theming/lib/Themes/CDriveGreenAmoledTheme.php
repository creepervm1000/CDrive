 ...
 *
 * CDrive Green AMOLED theme. Pure #000000 backgrounds, NO WHITE surfaces.
...
class CDriveGreenAmoledTheme extends DarkTheme implements ITheme {

	#[\Override]
	public function getId(): string {
		return 'cdrive-green-amoled';
	}

	#[\Override]
	public function getTitle(): string {
		return $this->l->t('CDrive Green AMOLED');
	}

	#[\Override]
	public function getEnableLabel(): string {
		return $this->l->t('Enable CDrive Green AMOLED');
	}

	#[\Override]
	public function getDescription(): string {
		return $this->l->t('Pure AMOLED black (#000000) with vivid green accent. No white surfaces.');
	}
	...
	public function getCSSVariables(): array {
		// Vivid green, high contrast on pure black
		$this->primaryColor = '#00E676';
